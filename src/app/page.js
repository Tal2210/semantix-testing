...
const HomePage = () => {
  ...
  const queriesWithImages = [
    ...
    {
      query: "Sportuhr mit GPS und Zahlungsfunktion, bis zu 250€",
      images: [
      ...
      <div className="w-full flex justify-start">
          <section className="text-left pl-4 mb-20">
            <button
              ...
              className="group relative bg-gradient-to-r from-purple-400 to-purple-500 hover: text-white font-bold py-3 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl flex items-center gap-3 relative right-4"
            >
