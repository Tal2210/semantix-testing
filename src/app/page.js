...
const HomePage = () => {
  ...
  const queriesWithImages = [
    {
      query: "Red wine that pairs well with meat, up to 25 bucks",
      images: [
        "/wine2.png",
        "/wine1.png",
        "/wine3.png",
    ...
    {
      query: "GPS sports watch with payment functionality, up to 250$",
      images: [
    ...
    {
      query: "I'm looking for a piece of jewelry for my daughter,she loves hearts and seashells",
      images: [
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col">
        {/* Mobile Layout */}
        <div className="flex-grow flex flex-col sm:hidden" style={{ maxHeight: '100vh' }}>
          <div className="flex flex-col w-full">
            <div className="flex justify-center items-center ml-6 mt-5">
              <h1
                className={`text-2xl sm:text-3xl lg:text-6xl font-bold mb-4 transition-opacity duration-500 ${
        ...
        <div className="flex-grow hidden sm:flex flex-col height-auto" style={{ maxHeight: '350px' }}>
          {/* Existing desktop layout code here */}
          <div className="flex w-full">
            <div className="w-2/3 justify-center items-center ml-6 mt-12">
              <h1
                className={`text-2xl sm:text-3xl lg:text-6xl font-bold mb-4 transition-opacity duration-500 ${
                  isFadingOut ? 'opacity-0' : 'opacity-100'
                }`}
        ...
        {/* Shared Section (Buttons, etc.) */}
        <div className="w-full flex justify-start">
          <section className="text-left pl-4 mb-20">
            <button
              onClick={() => router.push('/product')}
              className="group relative bg-gradient-to-r from-purple-400 to-purple-500 text-white font-bold py-3 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl flex items-center gap-3 relative right-4"
            >
              ...
              <svg
                ...
                strokeWidth={2}
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M7 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </button>
            ...
            <div className="flex mt-8 gap-5">
              ...
              {/* Email button */}
              <a
                href="mailto:Sales@semantix-ai.com"
                className="hover:opacity-80 transition-opacity"
              >
                <svg
