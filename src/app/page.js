  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      ...
      <div className="flex-grow flex flex-col items-center justify-center text-center">
        <h1
          className={`text-xl sm:text-2xl lg:text-4xl font-bold mb-4 transition-opacity duration-500 ${
      ...
      {/* Images section */}
      <div
        className={`w-full max-w-sm sm:max-w-md lg:max-w-lg mt-6 transition-opacity duration-700 ${
      ...
      <div className="w-full flex justify-center mt-8">
        <section className="text-center">
          <button
            ...
            className="group relative bg-gradient-to-r from-purple-400 to-purple-500 text-white font-bold py-3 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
          >
