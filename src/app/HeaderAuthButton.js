      ...
      <div dir="ltr" className="relative z-[9999]">
        {session ? (
          ...
          <button
            ref={buttonRef}
            onClick={() => setShow((s) => !s)}
            className="flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-black text-white border border-black hover:bg-white hover:text-black hover:shadow-lg transition-all duration-300 text-sm font-medium"
            aria-label="Sign in"
          >
            <span>Sign in</span>
