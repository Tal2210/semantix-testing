...
export default function PaymentMethodCancelled() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-yellow-50 flex items-center justify-center px-4">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Update Cancelled</h1>
        <p className="text-gray-600 mb-6">
          You have cancelled the payment method update. Your current payment method will continue to be used for future payments.
        </p>
